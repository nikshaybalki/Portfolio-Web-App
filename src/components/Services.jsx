    ...
    const servicesData = [
        {
            ...
            skills: [
                "Semantic UI & Layouts (HTML/CSS)",
                "Modern JS (ES6+) Logic (JavaScript)",
                "Dynamic SPA Development (React + Vite)",
                "High-End Motion Design (GSAP)",
                "Rapid Utility Styling (Tailwind CSS)",
        ...
        <div id="services" style={{ padding: '80px 0', background: '#080808' }}>
            <div className="container">
                ...
                <div className="services-list" style={{
                    display: 'grid',
                    gridTemplateColumns: '1fr', // Only one card now
                    maxWidth: '800px',
                    margin: '0 auto',
                    gridGap: '40px',
                }}>
