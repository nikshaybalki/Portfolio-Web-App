...
import React from 'react';
import { motion } from 'framer-motion';
import snapcutImg from '../assets/Snapcut-BG_removal.png';
import hardtoonzImg from '../assets/Hardtoonz.png';
import professorImg from '../assets/Professor-Of-How.png';
import auraImg from '../assets/Bussiness-Landing-Page.png';
import nexgenImg from '../assets/NexGen-Academy.png';
import eesaImg from '../assets/eesa.jpeg';
import rhygenImg from '../assets/rhygen.jpeg';
import noteshubImg from '../assets/NotesHub.jpeg';
import todoImg from '../assets/todo.png';
...
const Portfolio = () => {
    const projects = [
        {
            title: "SnapCut AI",
            desc: "AI-Powered Background Removal. Remove Backgrounds In Seconds. Upload any image and get a clean, transparent background instantly.",
            img: snapcutImg,
            link: "https://snapcut-bg.vercel.app"
        },
        {
            title: "HardToonz",
            desc: "HardToonz Universe | Indian Animated Comedy. Relatable Indian life, animated and roasted. Join 20M+ viewers in the funniest cartoon universe.",
            img: hardtoonzImg,
            link: "https://hardtoonz.vercel.app"
        },
        {
            title: "Professor Of How",
            desc: "Educational platform offering high-quality video tutorials and 3D animations to help you understand complex concepts easily.",
            img: professorImg,
            link: "https://professorofhow.vercel.app"
        },
        {
            title: "Aura Creative",
            desc: "Free Web Development Course & Developer Resource Library. Learn web development with free courses and templates to build projects faster.",
            img: auraImg,
            link: "https://auracreative.vercel.app"
        },
        {
            title: "NexGen Academy",
            desc: "The Step-by-Step Masterclass. We empower creators to build high-ticket digital empires with efficient AI-driven content workflows.",
            img: nexgenImg,
            link: "https://nex-gen2.vercel.app"
        },
        {
            title: "EESA CLUB WEB APPLICATION",
        ...
        {
            title: "RHYGEN",
            desc: "Rhygen is an automotive technology startup originating from IIT Bombay that develops hybrid powertrain solutions specifically for Indian commercial vehicles.",
            img: rhygenImg,
            link: "https://rhygen.vercel.app"
        },
        {
            title: "NotesHub MARKETPLACE",
